...
const ItemList = ({item}) => {
  ...
  return (
    <div className="container p-2 w-full bg-white shadow-lg rounded-lg">    
      <div className="block relative h-64 rounded overflow-hidden border border-gray-400">
      ...
      <div className="mt-4 flex flex-col">
          ...
          <p className="mt-1 font-bold text-gray-500 text-md truncate ">{item.attributes.description}...</p>
          <p className="mt-1 mb-2 font-bold text-gray-700 text-2xl">${item.attributes.price}</p>
